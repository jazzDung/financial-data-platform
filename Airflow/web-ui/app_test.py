...
def equation_calculator(df, eq, name):
    ...
    result.to_csv('/home/jazzdung/Project III/Airflow/data/airflow/generated/' + name + '.csv', sep=',', encoding='utf-8')
...
"""
    ...
    #Write to py file
    with open("/home/jazzdung/Project III/Airflow/dags (demos and drafts)/" + name + ".py", "w+") as dag:
        dag.write(script)
