 ...
 select * from general_rating limit 100;
 select * from business_model_rating limit 100;
 select * from business_operation_rating limit 100;
 select * from financial_health_rating limit 100;
 select * from valuation_rating limit 100;
 select * from industry_financial_health limit 100;
